"""
Unified AIS Data Generator
Combines both simple point-to-point and advanced multi-ship generation capabilities
"""
...
class AISGenerator:
    """Unified AIS data generator with both simple and advanced capabilities"""
    ...
    # Simple generation methods (backward compatibility)
    ...
    def add_simple_ship(self, route: Route, mmsi: int, ship_name: str = "VESSEL") -> SimpleShipMovement:
        """Add a simple ship to the generator"""
    ...
    # Advanced multi-ship generation methods
...
MultiShipGenerator = AISGenerator